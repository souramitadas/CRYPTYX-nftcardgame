...
export const GlobalContextProvider = ({ children }) => {
    ...
    const [gameData, setGameData] = useState({
        player: [], pendingBattles: [], activeBattle: null
    });
        ...
        const fetchGameData = async () => {
            if (contract) {
                ...
                fetchedBattles.forEach((battle) => {
                    if (
                        battle.players.find((player) => player.toLowerCase() === walletAddress.toLowerCase(),
                        )) {
    ...
    return (
        <GlobalContext.Provider value= {{
            ...
            battleName, setBattleName, gameData, battleGround, setBattleGround, errorMessage, setErrorMessage,
